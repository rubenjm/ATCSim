...
AirController::doWork()
{
      ...
      // // posiciones rutas de aterrizaje sector 1
      //
      // Position pos_at_s1_1(-1500,-5000,1570);
      // Position pos_at_s1_2(6500,-5000,1570);
      // Position pos_at_s1_3(5000,-11500,1570);
      //
      // // rutas aterrizaje sector 1
      //
      // Route r_at_s1_1,r_at_s1_2,r_at_s1_3;
      //
      // r_at_s1_1.pos = pos_at_s1_1;
      // r_at_s1_1.speed = 150;
      // r_at_s1_2.pos = pos_at_s1_2;
      // r_at_s1_2.speed = 150;
      // r_at_s1_3.pos = pos_at_s1_3;
      // r_at_s1_3.speed = 150;
